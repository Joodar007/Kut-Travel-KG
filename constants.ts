...
export const TOURS: Tour[] = [
    {
        ...
        description: "A comprehensive 13-day journey through the majestic Alay Mountains, experiencing the true nomadic lifestyle.",
    ...
    },
    {
        ...
        description: "Challenge yourself with a 10-day expedition to the foot of Lenin Peak, including a summit of Yuhin Peak (5130m).",
